...
const Job = ({offer}) => {
    ...
    return (
        <div className="select-none mx-auto p-5">
            <div onClick={() => history.push(`/ofertas/${id}`)}  className="max-w-lg appear mx-auto hover:bg-gray-100 md:max-w-5xl cursor-pointer flex bg justify-between rounded-xl border overflow-hidden p-5">
