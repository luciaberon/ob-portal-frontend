            ...
            <div class="container mx-auto px-4">
                <section class="py-8 px-4 text-center">
                    <div class="max-w-auto mx-auto">
                        ...
                        <h2 class="mt-8 uppercase text-xl lg:text-5xl font-black">Lo sentimos, página no encontrada!</h2>
                        <p class="mt-6 uppercase text-sm lg:text-base text-gray-900">La página que está buscando ha sido removida o no está disponible.</p>
                        <a onClick={() => history.push('/')} class="mt-6 bg-blue-500 hover:bg-blue-700 text-white font-light py-4 px-6 rounded-full inline-block uppercase shadow-md">Volver</a>
                    </div>
                </section>
            </div>
        </div>
